...
/* $Id: Smarty_Compiler.class.php,v 1.204 2003/04/11 13:40:40 mohrt Exp $ */
...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($tpl_file, $template_source, &$template_compiled)
    {
        ...
        if (!function_exists('annihilateComments')) {
            function annihilateComments ($match)
            {
                return $match[1] . '*' . str_repeat("\n", substr_count($match[2], "\n")) . '*' . $match[3];
            }
        }

        $template_source = preg_replace_callback($pattern, 'annihilateComments', $template_source);

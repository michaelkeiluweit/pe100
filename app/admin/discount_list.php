...
class Discount_list extends oxAdminView
{
    function Init()
    {   global $myConfig;
        global $mySession;
        ...
        $this->sListType    = "oxdiscountlist";

        // create navigation
        $this->aEditNavigation = array();

        $oNavItem->name     = "Stamm";
        $oNavItem->location = "discount_main";
    ...
    {   global $myConfig;
        ...
        $this->aViewData["default_edit"] =  "discount_main";
        
        return "discount_list.tpl";
    }
}

...
<br>
Hallo [{ $user->oxuser__oxsal->value }] [{ $user->oxuser__oxfname->value }] [{ $user->oxuser__oxlname->value }],
vielen Dank f&uuml;r Ihre Registrierung im NFQ eSales Onlineshop !<br>
<br>
Sie k&ouml;nnen sich ab sofort auch mit Ihrer Kundennummer <b>[{ $user->oxuser__oxcustnr->value }]</b> einloggen.<br>
<br>

...
<tr>
    <td class="listheader" height="15">&nbsp;&nbsp;&nbsp;<a href="Javascript:document.search.sort.value='oxuser.oxusername';document.search.submit();" class="listheader">Name</a></td>
    <td class="listheader">&nbsp;&nbsp;&nbsp;<a href="Javascript:document.search.sort.value='oxuser.oxstreet';document.search.submit();" class="listheader">Strasse</a></td>
    <td class="listheader">&nbsp;&nbsp;&nbsp;<a href="Javascript:document.search.sort.value='oxuser.oxzip';document.search.submit();" class="listheader">Plz</a></td>
    <td class="listheader">&nbsp;&nbsp;&nbsp;<a href="Javascript:document.search.sort.value='oxuser.oxcity';document.search.submit();" class="listheader">Ort</a></td>
    <td class="listheader">&nbsp;&nbsp;&nbsp;<a href="Javascript:document.search.sort.value='oxuser.oxfon';document.search.submit();" class="listheader">Telefon</a></td>
...
<tr>
    ...
    [{ /if}]
    <td valign="top" class="[{ $listclass}]" height="15"><a href="Javascript:EditThis('[{ $listitem->oxuser__oxid->value}]');" class="[{ $listclass}]">[{ if !$listitem->oxuser__oxlname->value }]-kein Name-[{else}][{ $listitem->oxuser__oxlname->value }][{/if}] [{ $listitem->oxuser__oxfname->value }]</a></td>
    <td valign="top" class="[{ $listclass}]"><a href="Javascript:EditThis('[{ $listitem->oxuser__oxid->value }]');" class="[{ $listclass}]">[{ $listitem->oxuser__oxstreet->value }]</a></td>
    <td valign="top" class="[{ $listclass}]"><a href="Javascript:EditThis('[{ $listitem->oxuser__oxid->value }]');" class="[{ $listclass}]">[{ $listitem->oxuser__oxzip->value }]</a></td>
    <td valign="top" class="[{ $listclass}]"><a href="Javascript:EditThis('[{ $listitem->oxuser__oxid->value }]');" class="[{ $listclass}]">[{ $listitem->oxuser__oxcity->value }]</a></td>
    <td valign="top" class="[{ $listclass}]"><a href="Javascript:EditThis('[{ $listitem->oxuser__oxid->value }]');" class="[{ $listclass}]">[{ $listitem->oxuser__oxfon->value }]</a></td>
    <td class="[{ $listclass}]"><a href="Javascript:DeleteThis('[{ $listitem->oxuser__oxid->value }]');" class="[{ $listclass}]"><img src="[{$shop->imagedir}]/delete_button.gif" hspace="0" vspace="0" border="0" align="middle" alt="" [{include file="help.tpl" helpid=item_delete}]></a></td>
</tr>
[{if $blWhite == "2"}]
[{assign var="blWhite" value=""}]
[{else}]

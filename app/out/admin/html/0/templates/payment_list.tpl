...
<tr>
    <td class="listheader" height="15">&nbsp;&nbsp;&nbsp;<a href="Javascript:document.search.sort.value='oxpayments.oxdesc';document.search.submit();" class="listheader">Beschreibung</a></td>
...
<tr>
    ...
    [{ /if}]
    <td valign="top" class="[{ $listclass}]" height="15"><a href="Javascript:EditThis('[{ $listitem->oxpayments__oxid->value}]');" class="[{ $listclass}]">[{ $listitem->oxpayments__oxdesc->value }]</a></td>
    <td class="[{ $listclass}]">
    [{ if !$listitem->isinternal }]
    <a href="Javascript:DeleteThis('[{ $listitem->oxpayments__oxid->value }]');" class="[{ $listclass}]"><img src="[{$shop->imagedir}]/delete_button.gif" hspace="0" vspace="0" border="0" align="middle" alt="" [{include file="help.tpl" helpid=item_delete}]></a>
    [{/if}]
    </td>
</tr>
[{if $blWhite == "2"}]

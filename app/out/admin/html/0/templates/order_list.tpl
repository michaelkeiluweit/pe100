...
<tr class="listitem">
    ...
    <input class="listedit" type="text" size="20" maxlength="128" name="where[oxorder.oxorderdate]" value="[{ $where->oxorder__oxorderdate }]" [{include file="help.tpl" helpid=order_date}]>
    </td>
    <td valign="top" class="listitem" height="20">
    <input class="listedit" type="text" size="5" maxlength="128" name="where[oxorder.oxordernr]" value="[{ $where->oxorder__oxordernr }]">
    </td>
    <td valign="top" class="listitem" height="20">
...
<tr>
    <td class="listheader" height="15">&nbsp;&nbsp;&nbsp;<a href="Javascript:document.search.sort.value='oxorder.oxorderdate';document.search.submit();" class="listheader">Bestellzeit</a></td>
    <td class="listheader" height="15"><a href="Javascript:document.search.sort.value='oxorder.oxordernr';document.search.submit();" class="listheader">Bestellnr.</a></td>
    <td class="listheader" height="15"><a href="Javascript:document.search.sort.value='oxorder.oxbilllname';document.search.submit();" class="listheader">Kunde</a></td>
...
<tr>
    ...
    [{ /if}]
    <td valign="top" class="[{ $listclass}]" height="15"><a href="Javascript:EditThis('[{ $listitem->oxorder__oxid->value}]');" class="[{ $listclass}]">[{ $listitem->oxorder__oxorderdate->value }]</a></td>
    <td valign="top" class="[{ $listclass}]" height="15"><a href="Javascript:EditThis('[{ $listitem->oxorder__oxid->value}]');" class="[{ $listclass}]">[{ $listitem->oxorder__oxordernr->value }]</a></td>
    <td valign="top" class="[{ $listclass}]" height="15"><a href="Javascript:EditThis('[{ $listitem->oxorder__oxid->value}]');" class="[{ $listclass}]">[{ $listitem->oxorder__oxbilllname->value }] [{ $listitem->oxorder__oxbillfname->value }]</a></td>
    <td class="[{ $listclass}]"><a href="Javascript:DeleteThis('[{ $listitem->oxorder__oxid->value }]');" class="[{ $listclass}]"><img src="[{$shop->imagedir}]/delete_button.gif" hspace="0" vspace="0" border="0" align="middle" alt="" [{include file="help.tpl" helpid=item_delete}]></a></td>
</tr>
[{if $blWhite == "2"}]
[{assign var="blWhite" value=""}]
[{else}]

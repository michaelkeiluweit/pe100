...
<tr>
    <td class="listheader" height="15">&nbsp;&nbsp;&nbsp;<a href="Javascript:document.search.sort.value='oxnewsletter.oxtitle';document.search.submit();" class="listheader">Titel</a></td>
...
<tr>
    ...
    [{ /if}]
    <td valign="top" class="[{ $listclass}]" height="15"><a href="Javascript:EditThis('[{ $listitem->oxnewsletter__oxid->value}]');" class="[{ $listclass}]">[{ $listitem->oxnewsletter__oxtitle->value }]</a></td>
    <td class="[{ $listclass}]"><a href="Javascript:DeleteThis('[{ $listitem->oxnewsletter__oxid->value }]');" class="[{ $listclass}]"><img src="[{$shop->imagedir}]/delete_button.gif" hspace="0" vspace="0" border="0" align="middle" alt="" [{include file="help.tpl" helpid=item_delete}]></a></td>
</tr>
[{if $blWhite == "2"}]
[{assign var="blWhite" value=""}]
[{else}]

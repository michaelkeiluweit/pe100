...
<head>
	...
	<META HTTP-EQUIV=Refresh CONTENT="[{$refresh}]; URL=[{$shop->selflink}]?cl=imex_do&sid=[{$shop->sid}]&iStart=[{ $iStart}]&fnc=[{ $fnc}]&param=[{$param}]"> 
</head>
...
<tr>
<td class="editnavigation" height="201">[{$text}] [{$table}] [{ $iStart}]</td>
<td></td>
</tr>
</table>

...
<form name="search" id="search" action="[{ $shop->selflink }]" method="post">
    [{ $shop->hiddensid }]
    <input type="hidden" name="cl" value="vat_list">
...
<tr class="listitem">
    ...
    <input class="listedit" type="text" size="50" maxlength="128" name="where[oxdiscount.oxtitle]" value="[{ $where->oxdiscount__oxtitle }]">
    </td>
...
<tr>
    <td class="listheader" height="15"><a href="Javascript:document.search.sort.value='oxdiscount.oxtitle';document.search.submit();" class="listheader">Beschreibung</a></td>
...
<tr>
    ...
    [{ /if}]
    <td valign="top" class="[{ $listclass}]" height="15"><a href="Javascript:EditThis('[{ $listitem->oxdiscount__oxid->value}]');" class="[{ $listclass}]">[{ $listitem->oxdiscount__oxtitle->value }]</a></td>
    <td class="[{ $listclass}]"><a href="Javascript:DeleteThis('[{ $listitem->oxdiscount__oxid->value }]');" class="[{ $listclass}]"><img src="[{$shop->imagedir}]/delete_button.gif" hspace="0" vspace="0" border="0" align="middle" alt="" [{include file="help.tpl" helpid=item_delete}]></a></td>
</tr>
[{if $blWhite == "2"}]
[{assign var="blWhite" value=""}]
[{else}]

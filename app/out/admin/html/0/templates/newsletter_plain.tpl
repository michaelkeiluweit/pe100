...
<tr>
    ...
    <td valign="top" class="edittext">
        ...
        <tr>
            ...
            <td class="edittext">
		    <textarea class="editinput" cols="120" rows="20" wrap="VIRTUAL" name="editval[oxnewsletter__oxplaintemplate]">[{$edit->oxnewsletter__oxplaintemplate->value}]</textarea><br>
            </td>
        </tr>
        <tr>
            <td class="edittext">

...
function ChangeLanguage()
{
    ...
    parent.edit.document.transfer.oxid.value='-1';
    parent.edit.document.transfer.cl.value='selectlist_main';
    parent.edit.transfer.submit();
...
<form name="search" id="search" action="[{ $shop->selflink }]" method="post">
    [{ $shop->hiddensid }]
    <input type="hidden" name="cl" value="selectlist_list">
...
<tr class="listitem">
    ...
    <input class="listedit" type="text" size="50" maxlength="128" name="where[oxselectlist.oxtitle]" value="[{ $where->oxselectlist__oxtitle }]">
    </td>
    <td valign="top" class="listitem" height="20">
...
<tr>
    <td class="listheader" height="15"><a href="Javascript:document.search.sort.value='oxselectlist.oxtitle';document.search.submit();" class="listheader">Beschreibung</a></td>
...
<tr>
    ...
    [{ /if}]
    <td valign="top" class="[{ $listclass}]" height="15"><a href="Javascript:EditThis('[{ $listitem->oxselectlist__oxid->value}]');" class="[{ $listclass}]">[{ $listitem->oxselectlist__oxtitle->value }]</a></td>
    <td class="[{ $listclass}]">&nbsp;</td>
    <td class="[{ $listclass}]"><a href="Javascript:DeleteThis('[{ $listitem->oxselectlist__oxnid->value }]');" class="[{ $listclass}]"><img src="[{$shop->imagedir}]/delete_button.gif" hspace="0" vspace="0" border="0" align="middle" alt="" [{include file="help.tpl" helpid=item_delete}]></a></td>
</tr>
[{if $blWhite == "2"}]
[{assign var="blWhite" value=""}]
[{else}]
